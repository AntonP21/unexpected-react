...
var TestComp = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(TestComp, [{
    ...
    value: function render() {
      return /*#__PURE__*/React.createElement("div", null, "dummy");
    }
  }]);
...
describe('unexpected-react included after react', function () {
  ...
  describe('with `to have rendered`', function () {
    it('throws a helpful error message', function () {
      var component = TestUtils.renderIntoDocument( /*#__PURE__*/React.createElement(TestComp, null));
      expect(function () {
        return expect(component, 'to have rendered', /*#__PURE__*/React.createElement("div", null, "dummy"));
      }, 'to error', EXPECTED_ERROR_MESSAGE);
    });
  });
  describe('with `to contain`', function () {
    it('throws a helpful error message', function () {
      var component = TestUtils.renderIntoDocument( /*#__PURE__*/React.createElement(TestComp, null));
      expect(function () {
        return expect(component, 'to contain', /*#__PURE__*/React.createElement("div", null, "dummy"));
      }, 'to error', EXPECTED_ERROR_MESSAGE);
    });
  });
});