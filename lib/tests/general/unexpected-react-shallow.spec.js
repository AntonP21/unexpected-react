...
var isReact014 = parseFloat(versionParts[0] + '.' + versionParts[1]) >= 0.14; //expect.outputFormat('text');
...
describe('unexpected-react-shallow', function () {
  ...
  it('identifies a ReactElement', function () {
    renderer.render( /*#__PURE__*/React.createElement(MyDiv, null));
  ...
  if (isReact014) {
    it('identifies a pure function component', function () {
      renderer.render( /*#__PURE__*/React.createElement(FunctionComp, null));
      var element = renderer.getRenderOutput();
      expect(element, 'to be a', 'ReactElement');
    });
  }
  ...
  describe('inspect', function () {
    ...
    it('outputs a tag element with string  props', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, {
        className: "test"
      }));
    ...
    it('outputs an ES5 createClass component props and no children', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement(ES5Component, {
        className: "test"
      }, "some content")));
    ...
    it('outputs an ES5 class component props and children', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement(ClassComponent, {
        className: "test"
      }, "some content")));
    ...
    it('outputs a set of deep nested components', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement(ClassComponent, {
        ...
        more: true,
        props: "yeah"
      }, "some content"), /*#__PURE__*/React.createElement(ClassComponent, {
        some: 1,
        more: true,
        props: "yeah"
    ...
    it('outputs a directly created custom ReactElement', function () {
      expect( /*#__PURE__*/React.createElement(ClassComponent, {
        className: "foo"
      }), 'to inspect as', '<ClassComponent className="foo" />');
    });
    it('outputs a directly created native ReactElement', function () {
      expect( /*#__PURE__*/React.createElement("div", {
        className: "foo"
      }), 'to inspect as', '<div className="foo" />');
    });
  ...
  describe('diff', function () {
    it('diffs within simple text content inside native element', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, "Some simple content"));
      var expected = /*#__PURE__*/React.createElement("div", null, "Different content");
    ...
    it('shows changed props within a simple native element', function () {
      ...
      return expect(function () {
        return expect(renderer, 'to have rendered', /*#__PURE__*/React.createElement("div", {
          className: "expected"
        }, "Some simple content"));
    ...
    it('does not ignore extra props when using `exactly`', function () {
      ...
      return expect(function () {
        return expect(renderer, 'to have exactly rendered', /*#__PURE__*/React.createElement("div", {
          id: "123"
        }, "Some simple content"));
    ...
    it('matches props on a custom component', function () {
      ...
      return expect(renderer, 'to have exactly rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ClassComponent, {
        className: "foo",
        test: true
      }, /*#__PURE__*/React.createElement("span", {
        className: "bar"
    ...
    it('diffs className with an extra class on actual with `with all classes', function () {
      ...
      expect(function () {
        return expect(renderer, 'to have rendered with all classes', /*#__PURE__*/React.createElement("div", {
          className: "one two"
        }));
    ...
    it('matches content rendered as a number', function () {
      renderer.render( /*#__PURE__*/React.createElement(ClassComponent, {
        content: 0
      }));
      return expect(renderer, 'to have rendered', /*#__PURE__*/React.createElement("div", {
        className: "class-component"
    ...
    it('ignores extra props on a nested custom component when not using `exactly`', function () {
      ...
      return expect(renderer, 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ClassComponent, {
        className: "foo",
        test: true
      }, /*#__PURE__*/React.createElement("span", {
        className: "bar"
    ...
    it('matches immutable array of children in a custom component', function () {
      var items = new Immutable.List([/*#__PURE__*/React.createElement("span", {
        key: "1",
        className: "one"
      }, "1"), /*#__PURE__*/React.createElement("span", {
        key: "2",
    ...
    it('highlights different typed children', function () {
      ...
      return expect(function () {
        return expect(renderer, 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ClassComponent, {
          className: "foo",
          test: true
        }, /*#__PURE__*/React.createElement(ES5Component, {
          child: true
        }))));
    ...
    it('matches a multi-text child', function () {
      var content = 'test';
      var content2 = 'test';
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement(ClassComponent, null, "some text ", content)));
      return expect(renderer, 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ClassComponent, null, "some text ", content2)));
    });
    it('matches a multi-text child to a single text child without exactly', function () {
      var content = 'test';
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement(ClassComponent, null, "some text ", content)));
      return expect(renderer, 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ClassComponent, null, "some text test")));
    });
    it('matches a multi-text child including a number to a single text child without exactly', function () {
      var content = 5;
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement(ClassComponent, null, "some ", content, " value")));
      return expect(renderer, 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ClassComponent, null, "some 5 value")));
    });
    it('matches a multi-text child including a null to a single text child without exactly', function () {
      var content = null;
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement(ClassComponent, null, "some ", content, " value")));
      return expect(renderer, 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ClassComponent, null, "some  value")));
    });
    ...
    it('matches a multi-text child including a boolean to a single text child without exactly', function () {
      var content = true;
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement(ClassComponent, null, "some ", content, " value"))); // An inline boolean is converted to null, so this "just works"
    ...
    it('highlights string break-down changes in a multi-text child with `exactly`', function () {
      ...
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement(ClassComponent, null, "some text ", content)));
      return expect(function () {
        return expect(renderer, 'to have exactly rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ClassComponent, null, "some text test")));
    ...
    it('matches a mixed content child', function () {
      var content = /*#__PURE__*/React.createElement(ES5Component, {
        foo: "bar"
      });
      var content2 = /*#__PURE__*/React.createElement(ES5Component, {
        foo: "bar"
      });
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement(ClassComponent, null, "some text ", content)));
      return expect(renderer, 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ClassComponent, null, "some text ", content2)));
    ...
    it('highlights removals in multi-string content', function () {
      var content = 'test';
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement(ClassComponent, null, "some text")));
      return expect(function () {
        return expect(renderer, 'to have exactly rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ClassComponent, null, "some text ", content)));
    ...
    it('highlights removals in complex content with exactly', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement(ClassComponent, null, /*#__PURE__*/React.createElement("div", {
        className: "one"
      }), /*#__PURE__*/React.createElement(ES5Component, {
        className: "three"
      }), /*#__PURE__*/React.createElement("span", null, "foo"))));
      return expect(function () {
        return expect(renderer, 'to have exactly rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ClassComponent, null, /*#__PURE__*/React.createElement("div", {
          className: "one"
        }), /*#__PURE__*/React.createElement("span", null, "foo"))));
    ...
    it('highlights removals in complex content with `with all children`', function () {
      ...
      return expect(function () {
        return expect(renderer, 'to have rendered with all children', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ClassComponent, null, /*#__PURE__*/React.createElement("div", {
          className: "one"
        }), /*#__PURE__*/React.createElement("span", null, "foo"))));
    ...
    it('highlights the block removal for deep children', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement("ul", null, /*#__PURE__*/React.createElement("li", {
        key: "1"
      }, "one"), /*#__PURE__*/React.createElement("li", {
        key: "2"
      }, "two"), /*#__PURE__*/React.createElement("li", {
        key: "3"
      }, "three"))));
      return expect(function () {
        return expect(renderer, 'to have rendered with all children', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("ul", null, /*#__PURE__*/React.createElement("li", {
          key: "1"
        }, "one"), /*#__PURE__*/React.createElement("li", {
          key: "2"
        }, "two"))));
    ...
    it('highlights the block removal when mixing hardcoded elements add generated lists', function () {
      var numbers = [/*#__PURE__*/React.createElement("span", {
        key: "1"
      }, "one"), /*#__PURE__*/React.createElement("span", {
        key: "2"
      }, "two"), /*#__PURE__*/React.createElement("span", {
        key: "3"
      }, "three")];
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement("h1", null, "My numbers"), numbers));
      return expect(function () {
        return expect(renderer, 'to have rendered with all children', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h1", null, "My numbers"), /*#__PURE__*/React.createElement("span", {
          key: "1"
        }, "one"), /*#__PURE__*/React.createElement("span", {
          key: "2"
        }, "two")));
    ...
    it('identifies when a string element should be a real element', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, {
        className: "outer"
      }, /*#__PURE__*/React.createElement("span", null, "123")));
      return expect(function () {
        return expect(renderer, 'to have rendered with all wrappers', /*#__PURE__*/React.createElement("div", {
          className: "outer"
        }, "123"));
    ...
    it('ignores components that render null in an array when using `with all children`', function () {
      var RenderNull = createClass({
        render: function render() {
          var children = [/*#__PURE__*/React.createElement("span", {
            key: "1"
          }, "one"), null, /*#__PURE__*/React.createElement("span", {
            key: "2"
          }, "two")];
          return /*#__PURE__*/React.createElement("div", {
            className: "something"
      ...
      renderer.render( /*#__PURE__*/React.createElement(RenderNull, null));
      return expect(renderer, 'to have rendered with all children', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", null, "one"), /*#__PURE__*/React.createElement("span", null, "two")));
    });
    it('ignores null children when using `with all children`', function () {
      var RenderNull = createClass({
        render: function render() {
          return /*#__PURE__*/React.createElement("div", null, null);
        }
      });
      renderer.render( /*#__PURE__*/React.createElement(RenderNull, null));
      return expect(renderer, 'to have rendered with all children', /*#__PURE__*/React.createElement("div", null));
    });
  ...
  describe('`to equal`', function () {
    it('matches renderer output to a component tree', function () {
      ...
      return expect(renderer.getRenderOutput(), 'to equal', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ClassComponent, {
        className: "foo"
      })));
    });
  ...
  describe('contains', function () {
    it('finds an match at the top level', function () {
      ...
      return expect(renderer, 'to contain', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ClassComponent, {
        className: "foo"
      })));
    });
    it('finds a match at a deeper level', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(ClassComponent, {
        className: "foo"
      }))));
      return expect(renderer, 'to contain', /*#__PURE__*/React.createElement(ClassComponent, {
        className: "foo"
      }));
    });
    it('finds a string content', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement("span", null, "some content one"), /*#__PURE__*/React.createElement("span", null, "some content two")));
    ...
    it('finds a multi-part string', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement("span", null, "button clicked ", 5, " times")));
    ...
    it('finds a match in an array of children', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement("span", null, "nested"), /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(ClassComponent, {
        className: "bar"
      }), /*#__PURE__*/React.createElement(ClassComponent, {
        className: "foo"
      }), /*#__PURE__*/React.createElement(ClassComponent, {
    ...
    it('does not find a match when the children of a candidate match are different', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement("span", null, "nested"), /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(ClassComponent, {
        ...
        className: "candidate"
      }, /*#__PURE__*/React.createElement("span", null, "something else")))));
      return expect(function () {
        return expect(renderer, 'to contain', /*#__PURE__*/React.createElement(ClassComponent, {
          className: "candidate"
        }, /*#__PURE__*/React.createElement("span", null, "cheese")));
    ...
    it('finds the match when there are extra children in the render, but `exactly` is not used', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement("span", null, "nested"), /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(ClassComponent, {
        ...
        className: "candidate"
      }, /*#__PURE__*/React.createElement("span", null, "one"), /*#__PURE__*/React.createElement("span", null, "two"), /*#__PURE__*/React.createElement("span", null, "three")))));
      return expect(renderer, 'to contain', /*#__PURE__*/React.createElement(ClassComponent, {
        className: "candidate"
      }, /*#__PURE__*/React.createElement("span", null, "one"), /*#__PURE__*/React.createElement("span", null, "three")));
    });
    ...
    it('does not find a match when there are extra props in the render, and `exactly` is used', function () {
      ...
      return expect(function () {
        return expect(renderer, 'to contain exactly', /*#__PURE__*/React.createElement(ClassComponent, {
          className: "candidate"
        }));
    ...
    it('does not find a match when there are extra children in the render, and `with all children` is used', function () {
      ...
      return expect(function () {
        return expect(renderer, 'to contain with all children', /*#__PURE__*/React.createElement(ClassComponent, {
          className: "candidate"
        }, /*#__PURE__*/React.createElement("span", null, "one"), /*#__PURE__*/React.createElement("span", null, "three")));
    ...
    it('matches even with removals in complex content without `exactly`', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement(ClassComponent, null, /*#__PURE__*/React.createElement(MyDiv, {
        className: "one"
      }), /*#__PURE__*/React.createElement(ES5Component, {
        className: "three"
      }), /*#__PURE__*/React.createElement("span", null, "foo"))));
      return expect(renderer, 'to contain', /*#__PURE__*/React.createElement(ClassComponent, null, /*#__PURE__*/React.createElement(MyDiv, {
        className: "one"
      }), /*#__PURE__*/React.createElement("span", null, "foo")));
    });
    it('does not match with a removal and an addition in complex content with `exactly`', function () {
      ...
      return expect(function () {
        return expect(renderer, 'to contain exactly', /*#__PURE__*/React.createElement(ClassComponent, null, /*#__PURE__*/React.createElement("div", {
          className: "one"
        }), /*#__PURE__*/React.createElement(ClassComponent, {
          className: "three"
        }), /*#__PURE__*/React.createElement("span", null, "foo")));
  ...
  describe('not contains', function () {
    beforeEach(function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement("span", {
        id: "foo",
        className: "extra"
      })));
    });
    it('passes when the content is not found', function () {
      return expect(renderer, 'not to contain', /*#__PURE__*/React.createElement("span", {
        id: "bar"
      }));
    });
  ...
  describe('to satisfy', function () {
    describe('renderOutput', function () {
      it('should satisfy a matching output', function () {
        ...
        return expect(renderer.getRenderOutput(), 'to satisfy', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", null, "foo"), /*#__PURE__*/React.createElement("span", null, "bar")));
      });
    });
  });
  describe('with expect.it', function () {
    it('throws when expect.it fails', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement("span", null, "some Text")));
      return expect(function () {
        return expect(renderer, 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", null, expect.it('to match', /a-z /))));
    ...
    it('returns a rejected promise when expect.it is async and fails', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement("span", null, "some Text")));
      return expect(expect(renderer, 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", null, expect.it('to eventually equal', 'something different')))), 'to be rejected with', 'expected <div><span>some Text</span></div>\n' + 'to have rendered <div><span>{expect.it(\'to eventually equal\', \'something different\')}</span></div>\n' + '\n' + '<div>\n' + '  <span>\n' + '    some Text // expected \'some Text\' to eventually equal \'something different\'\n' + '  </span>\n' + '</div>');
    });
    it('returns a resolved promise when expect.it is async and passes', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement("span", null, "some Text")));
      return expect(expect(renderer, 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", null, expect.it('to eventually equal', 'some Text')))), 'to be fulfilled');
    });
    it('returns a resolved promise when expect.it is async and passes for `contains`', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, null, /*#__PURE__*/React.createElement("span", null, "some Text")));
      expect(renderer, 'to contain', /*#__PURE__*/React.createElement("span", null, expect.it('to eventually equal', 'some Text')));
      return expect(expect(renderer, 'to contain', /*#__PURE__*/React.createElement("span", null, expect.it('to eventually equal', 'some Text'))), 'to be fulfilled');
    });
  });
  describe('queried for', function () {
    it('finds an element in a tree', function () {
      renderer.render( /*#__PURE__*/React.createElement(MyDiv, {
        ...
        className: "bar"
      }, /*#__PURE__*/React.createElement("span", null, "bar")), /*#__PURE__*/React.createElement(MyDiv, {
        className: "baz"
      }, /*#__PURE__*/React.createElement("span", null, "baz"))));
      expect(renderer.getRenderOutput(), 'queried for', /*#__PURE__*/React.createElement(MyDiv, {
        className: "bar"
      }), 'to have rendered', /*#__PURE__*/React.createElement(MyDiv, {
        className: "bar"
      }, /*#__PURE__*/React.createElement("span", null, "bar")));
    });
    it('using the renderer finds an element in a tree', function () {
      ...
      expect(renderer, 'queried for', /*#__PURE__*/React.createElement(MyDiv, {
        className: "bar"
      }), 'to have rendered', /*#__PURE__*/React.createElement(MyDiv, {
        className: "bar"
      }, /*#__PURE__*/React.createElement("span", null, "bar")));
    ...
    it('errors when no component is found', function () {
      ...
      expect(function () {
        return expect(renderer, 'queried for', /*#__PURE__*/React.createElement(MyDiv, {
    ...
    it('locates with an async expect.it', function () {
      ...
      return expect(renderer, 'queried for', /*#__PURE__*/React.createElement(MyDiv, {
        className: expect.it('to eventually equal', 'bar')
      }), 'to have rendered', /*#__PURE__*/React.createElement(MyDiv, {
        className: "bar"
      }, /*#__PURE__*/React.createElement("span", null, "bar")));
    });
    ...
    it('passes the `queryTarget` forward as the target of the query', function () {
      ...
      expect(renderer, 'queried for', /*#__PURE__*/React.createElement(MyDiv, {
        ...
        queryTarget: true
      })), 'to have exactly rendered', /*#__PURE__*/React.createElement("span", null, "bar"));
    });
  });
  describe('with events', function () {
      ...
      ClickableComponent = createClass({
        ...
        render: function render() {
          return /*#__PURE__*/React.createElement("div", {
            ...
            onAliensLanded: this.handleAliensLanded
          }, /*#__PURE__*/React.createElement("span", {
          ...
          }, "Item clicked ", this.state.itemClickCount));
        }
      });
    });
    it('calls click on a component', function () {
      renderer.render( /*#__PURE__*/React.createElement(ClickableComponent, null));
      expect(renderer, 'with event', 'click', 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
        className: "main-click"
      }, "Main clicked 1")));
    });
    it('calls click on a part of a component', function () {
      renderer.render( /*#__PURE__*/React.createElement(ClickableComponent, null));
      expect(renderer, 'with event', 'click', 'on', /*#__PURE__*/React.createElement("span", {
    ...
    it('errors with a helpful error message when the event is not known', function () {
      ...
      expect(function () {
        return textExpect(renderer, 'with event', 'foo', 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
          className: "item-click"
        }, "Item clicked 1")));
    ...
    it('calls non-standard events', function () {
      renderer.render( /*#__PURE__*/React.createElement(ClickableComponent, null));
      expect(renderer, 'with event', 'aliensLanded', 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
        className: "main-click"
      }, "Main clicked 10")));
    });
    it('calls events with event parameters', function () {
      renderer.render( /*#__PURE__*/React.createElement(ClickableComponent, null));
      expect(renderer, 'with event', 'aliensLanded', {
        increment: 1000
      }, 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
        className: "main-click"
      }, "Main clicked 1000")));
    ...
    it('calls events with event parameters with `to contain with all children`', function () {
      ...
      expect(renderer, 'with event', 'aliensLanded', {
        increment: 1000
      }, 'to contain with all children', /*#__PURE__*/React.createElement("span", {
        className: "main-click"
      }, "Main clicked 1000"));
    });
    ...
    it('errors with a helpful error message when the event target cannot be found', function () {
      renderer.render( /*#__PURE__*/React.createElement(ClickableComponent, null));
      expect(function () {
        return expect(renderer, 'with event', 'aliensLanded', {
          increment: 1000
    ...
    it('triggers events on raw components without a renderer', function () {
      expect( /*#__PURE__*/React.createElement(ClickableComponent, null), 'with event', 'click', 'on', /*#__PURE__*/React.createElement("span", {
        className: "item-click"
      }), 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
        className: "item-click"
      }, "Item clicked 1")));
    ...
    it('allows triggering multiple events with `and` and event args', function () {
      expect( /*#__PURE__*/React.createElement(ClickableComponent, null), 'with event', 'aliensLanded', {
        increment: 2
      }, 'and with event', 'aliensLanded', {
        increment: 4
      }, 'and with event', 'aliensLanded', {
        increment: 8
      }, 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
    ...
    it('passes the renderer with the event triggered as the fulfillment of the promise', function () {
      expect( /*#__PURE__*/React.createElement(ClickableComponent, null), 'with event', 'click').then(function (renderer) {
        expect(renderer, 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
          className: "main-click"
        }, "Main clicked 1")));
      });
    });
    it('passes the renderer with the event triggered as the fulfillment of the promise with event args', function () {
      expect( /*#__PURE__*/React.createElement(ClickableComponent, null), 'with event', 'aliensLanded', {
        ...
        expect(renderer.getRenderOutput(), 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
          className: "main-click"
        }, "Main clicked 5")));
      });
    });
    it('passes the renderer with the event triggered as the fulfillment of the promise with event args and `on`', function () {
      expect( /*#__PURE__*/React.createElement(ClickableComponent, null), 'with event', 'click', {
        increment: 5
      }, 'on', /*#__PURE__*/React.createElement("span", {
        className: "item-click"
      })).then(function (renderer) {
    ...
    it('passes the renderer with the event triggered as the fulfillment of the promise with multiple events', function () {
      return expect( /*#__PURE__*/React.createElement(ClickableComponent, null), 'with event', 'click', {
        increment: 5
      }, 'on', /*#__PURE__*/React.createElement("span", {
        className: "item-click"
      }), 'and with event', 'aliensLanded', {
        ...
        expect(renderer.getRenderOutput(), 'to have rendered', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
          className: "main-click"
        }, "Main clicked 7"), /*#__PURE__*/React.createElement("span", {
          className: "item-click"
        }, "Item clicked 5")));
      });
    });
  ...
  describe('when rendered', function () {
    it('renders a class component with the shallow renderer', function () {
      expect( /*#__PURE__*/React.createElement(ClassComponent, null), 'when rendered', 'to have rendered', /*#__PURE__*/React.createElement("div", {
        className: "class-component"
      }));
    });
    it('passes the renderer on as the fulfillment of the promise', function () {
      return expect( /*#__PURE__*/React.createElement(ClassComponent, null), 'when rendered').then(function (renderer) {
        expect(renderer, 'to be a', 'ReactShallowRenderer'); // Just an extra check, just in case the thing only looks like a renderer :)

        expect(renderer.getRenderOutput(), 'to equal', /*#__PURE__*/React.createElement("div", {
          className: "class-component"
        }));
      });
    });
    it('renders a stateless component', function () {
      expect( /*#__PURE__*/React.createElement(FunctionComp, {
        className: "test"
      }), 'when rendered', 'to have rendered', /*#__PURE__*/React.createElement("div", {
        className: "test"
      }));
    });
    it('passed the error on when the following assertion fails', function () {
      expect(function () {
        return expect( /*#__PURE__*/React.createElement(FunctionComp, {
          className: "test"
        }), 'when rendered', 'to have rendered', /*#__PURE__*/React.createElement("div", {
          className: "testx"
        }));
  ...
  describe('to render as', function () {
    it('validates a render', function () {
      expect( /*#__PURE__*/React.createElement(FunctionComp, {
        className: "test"
      }), 'to render as', /*#__PURE__*/React.createElement("div", {
        className: "test"
      }));
    });
    ...
    it('uses the exactly flag', function () {
      expect(function () {
        return expect( /*#__PURE__*/React.createElement(FunctionComp, {
          className: "foo"
        }), 'to exactly render as', /*#__PURE__*/React.createElement("div", null));
    ...
    it('uses the `with all classes` flag', function () {
      expect(function () {
        return expect( /*#__PURE__*/React.createElement(FunctionComp, {
          className: "foo bar"
        }), 'to render with all classes as', /*#__PURE__*/React.createElement("div", {
          className: "foo"
        }));
    ...
    it('provides the rendered component as the fulfillment value', function () {
      return expect( /*#__PURE__*/React.createElement(FunctionComp, null), 'to render as', /*#__PURE__*/React.createElement("div", null)).then(function (functionComp) {
  ...
  describe('with component returning array', function () {
    function TestArray() {
      return [/*#__PURE__*/React.createElement("div", {
        className: "foo bar"
      }, "one"), /*#__PURE__*/React.createElement("div", null, "two")];
    }

    describe('to render as', function () {
      it('passes when it matches', function () {
        expect( /*#__PURE__*/React.createElement(TestArray, null), 'to render as', [/*#__PURE__*/React.createElement("div", {
          className: "foo bar"
        }, "one"), /*#__PURE__*/React.createElement("div", null, "two")]);
      });
      it('errors for each failing element', function () {
        expect(function () {
          return expect( /*#__PURE__*/React.createElement(TestArray, null), 'to render as', [/*#__PURE__*/React.createElement("div", {
            className: "baz foo"
          }, "one"), /*#__PURE__*/React.createElement("div", null, "three")]);
      ...
      it('passes the flags for each element', function () {
        expect(function () {
          return expect( /*#__PURE__*/React.createElement(TestArray, null), 'to render with all classes as', [/*#__PURE__*/React.createElement("div", {
            className: "foo"
          }, "one"), /*#__PURE__*/React.createElement("div", null, "two")]);
    ...
    describe('to have rendered', function () {
      ...
      beforeEach(function () {
        renderer = createRenderer();
        renderer.render( /*#__PURE__*/React.createElement(TestArray, null));
      });
      it('passes when it matches', function () {
        expect(renderer, 'to have rendered', [/*#__PURE__*/React.createElement("div", {
          className: "foo bar"
        }, "one"), /*#__PURE__*/React.createElement("div", null, "two")]);
      });
