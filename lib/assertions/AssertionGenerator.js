...
var _reactEventNames = _interopRequireDefault(require("../reactEventNames"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

var PENDING_TEST_EVENT_TYPE = {
  dummy: 'Dummy object to identify a pending event on the test renderer'
};
...
AssertionGenerator.prototype._installEqualityAssertions = function (expect) {
  var _this$_options = this._options,
      actualTypeName = _this$_options.actualTypeName,
      expectedTypeName = _this$_options.expectedTypeName,
      getRenderOutput = _this$_options.getRenderOutput,
      actualRenderOutputType = _this$_options.actualRenderOutputType,
      getDiffInputFromRenderOutput = _this$_options.getDiffInputFromRenderOutput,
      ActualAdapter = _this$_options.ActualAdapter,
      ExpectedAdapter = _this$_options.ExpectedAdapter;
  expect.addAssertion(["<".concat(actualTypeName, "> to have [exactly] rendered <").concat(expectedTypeName, ">"), "<".concat(actualTypeName, "> to have rendered [with all children] [with all wrappers] [with all classes] [with all attributes] <").concat(expectedTypeName, ">")], function (expect, subject, renderOutput) {
  ...
  expect.addAssertion(["<".concat(actualRenderOutputType, "> to have [exactly] rendered <").concat(expectedTypeName, ">"), "<".concat(actualRenderOutputType, "> to have rendered [with all children] [with all wrappers] [with all classes] [with all attributes] <").concat(expectedTypeName, ">")], function (expect, subject, renderOutput) {
    ...
    var testHtmlLike = new _unexpectedHtmllike["default"](actualAdapter);

    if (!exactly) {
      expectedAdapter.setOptions({
        concatTextContent: true
      });
      actualAdapter.setOptions({
        concatTextContent: true
      });
    }
    ...
    var options = getDefaultOptions({
      exactly: exactly,
      withAllWrappers: withAllWrappers,
      withAllChildren: withAllChildren,
      withAllClasses: withAllClasses,
  ...
  expect.addAssertion(["<".concat(actualTypeName, "> [not] to contain [exactly] <").concat(expectedTypeName, "|string>"), "<".concat(actualTypeName, "> [not] to contain [with all children] [with all wrappers] [with all classes] [with all attributes] <").concat(expectedTypeName, "|string>")], function (expect, subject, renderOutput) {
    var actual = getRenderOutput(subject);
  ...
  expect.addAssertion(["<".concat(actualRenderOutputType, "> [not] to contain [exactly] <").concat(expectedTypeName, "|string>"), "<".concat(actualRenderOutputType, "> [not] to contain [with all children] [with all wrappers] [with all classes] [with all attributes] <").concat(expectedTypeName, "|string>")], function (expect, subject, expected) {
  ...
  expect.addAssertion("<".concat(actualTypeName, "> to equal <").concat(expectedTypeName, ">"), function (expect, subject, expected) {
    expect(getRenderOutput(subject), 'to equal', expected);
  });
  expect.addAssertion("<".concat(actualRenderOutputType, "> to equal <").concat(expectedTypeName, ">"), function (expect, subject, expected) {
    expect(subject, 'to have exactly rendered', expected);
  });
  expect.addAssertion("<".concat(actualTypeName, "> to satisfy <").concat(expectedTypeName, ">"), function (expect, subject, expected) {
    expect(getRenderOutput(subject), 'to satisfy', expected);
  });
  expect.addAssertion("<".concat(actualRenderOutputType, "> to satisfy <").concat(expectedTypeName, ">"), function (expect, subject, expected) {
...
AssertionGenerator.prototype._installQueriedFor = function (expect) {
  var _this$_options2 = this._options,
      actualTypeName = _this$_options2.actualTypeName,
      queryTypeName = _this$_options2.queryTypeName,
      getRenderOutput = _this$_options2.getRenderOutput,
      actualRenderOutputType = _this$_options2.actualRenderOutputType,
      getDiffInputFromRenderOutput = _this$_options2.getDiffInputFromRenderOutput,
      rewrapResult = _this$_options2.rewrapResult,
      wrapResultForReturn = _this$_options2.wrapResultForReturn,
      ActualAdapter = _this$_options2.ActualAdapter,
      QueryAdapter = _this$_options2.QueryAdapter;
  expect.addAssertion(["<".concat(actualTypeName, "> queried for [exactly] <").concat(queryTypeName, "> <assertion?>"), "<".concat(actualTypeName, "> queried for [with all children] [with all wrapppers] [with all classes] [with all attributes] <").concat(queryTypeName, "> <assertion?>")], function (expect, subject, query, assertion) {
  ...
  expect.addAssertion(["<".concat(actualRenderOutputType, "> queried for [exactly] <").concat(queryTypeName, "> <assertion?>"), "<".concat(actualRenderOutputType, "> queried for [with all children] [with all wrapppers] [with all classes] [with all attributes] <").concat(queryTypeName, "> <assertion?>")], function (expect, subject, query) {
    var exactly = this.flags.exactly;
    var withAllChildren = this.flags['with all children'];
    var withAllWrappers = this.flags['with all wrappers'];
    var withAllClasses = this.flags['with all classes'];
...
AssertionGenerator.prototype._installPendingEventType = function (expect) {
  ...
  expect.addType({
    ...
    identify: function identify(value) {
      return value && _typeof(value) === 'object' && value.$$typeof === PENDING_EVENT_IDENTIFIER;
    },
...
AssertionGenerator.prototype._installWithEvent = function (expect) {
  var _this$_options3 = this._options,
      actualTypeName = _this$_options3.actualTypeName,
      actualRenderOutputType = _this$_options3.actualRenderOutputType,
      triggerEvent = _this$_options3.triggerEvent,
      canTriggerEventsOnOutputType = _this$_options3.canTriggerEventsOnOutputType;
  var _this$_options$wrapRe = this._options.wrapResultForReturn,
      wrapResultForReturn = _this$_options$wrapRe === void 0 ? function (value) {
    return value;
  } : _this$_options$wrapRe;
  var actualPendingEventTypeName = this._actualPendingEventTypeName;
  var PENDING_EVENT_IDENTIFIER = this._PENDING_EVENT_IDENTIFIER;
  expect.addAssertion("<".concat(actualTypeName, "> with event <string> <assertion?>"), function (expect, subject, eventName) {
    for (var _len = arguments.length, assertion = new Array(_len > 3 ? _len - 3 : 0), _key = 3; _key < _len; _key++) {
  ...
  expect.addAssertion("<".concat(actualTypeName, "> with event (").concat(_reactEventNames["default"].join('|'), ") <assertion?>"), function (expect, subject) {
    for (var _len2 = arguments.length, assertion = new Array(_len2 > 2 ? _len2 - 2 : 0), _key2 = 2; _key2 < _len2; _key2++) {
      assertion[_key2 - 2] = arguments[_key2];
    }

    return expect.apply(void 0, [subject, 'with event', expect.alternations[0]].concat(assertion));
  });
  expect.addAssertion("<".concat(actualTypeName, "> with event <string> <object> <assertion?>"), function (expect, subject, eventName, eventArgs) {
  ...
  expect.addAssertion("<".concat(actualTypeName, "> with event (").concat(_reactEventNames["default"].join('|'), ") <object> <assertion?>"), function (expect, subject, eventArgs) {
    for (var _len3 = arguments.length, assertion = new Array(_len3 > 3 ? _len3 - 3 : 0), _key3 = 3; _key3 < _len3; _key3++) {
      assertion[_key3 - 3] = arguments[_key3];
    }

    return expect.apply(void 0, [subject, 'with event', expect.alternations[0], eventArgs].concat(assertion));
  });

  if (canTriggerEventsOnOutputType) {
    expect.addAssertion("<".concat(actualRenderOutputType, "> with event <string> <assertion?>"), function (expect, subject, eventName) {
      for (var _len4 = arguments.length, assertion = new Array(_len4 > 3 ? _len4 - 3 : 0), _key4 = 3; _key4 < _len4; _key4++) {
    ...
    expect.addAssertion("<".concat(actualRenderOutputType, "> with event (").concat(_reactEventNames["default"].join('|'), ") <assertion?>"), function (expect, subject) {
      for (var _len5 = arguments.length, assertion = new Array(_len5 > 2 ? _len5 - 2 : 0), _key5 = 2; _key5 < _len5; _key5++) {
        assertion[_key5 - 2] = arguments[_key5];
      }

      return expect.apply(void 0, [subject, 'with event', expect.alternations[0]].concat(assertion));
    });
    expect.addAssertion("<".concat(actualRenderOutputType, "> with event <string> <object> <assertion?>"), function (expect, subject, eventName, args) {
      if (arguments.length > 4) {
        return expect.shift({
          $$typeof: PENDING_EVENT_IDENTIFIER,
          renderer: subject,
    ...
    expect.addAssertion("<".concat(actualRenderOutputType, "> with event (").concat(_reactEventNames["default"].join('|'), ") <object> <assertion?>"), function (expect, subject, eventArgs) {
      for (var _len6 = arguments.length, assertion = new Array(_len6 > 3 ? _len6 - 3 : 0), _key6 = 3; _key6 < _len6; _key6++) {
  ...
  expect.addAssertion("<".concat(actualPendingEventTypeName, "> [and] with event <string> <assertion?>"), function (expect, subject, eventName) {
  ...
  expect.addAssertion("<".concat(actualPendingEventTypeName, "> [and] with event (").concat(_reactEventNames["default"].join('|'), ") <assertion?>"), function (expect, subject) {
    for (var _len7 = arguments.length, assertion = new Array(_len7 > 2 ? _len7 - 2 : 0), _key7 = 2; _key7 < _len7; _key7++) {
      assertion[_key7 - 2] = arguments[_key7];
    }

    return expect.apply(void 0, [subject, 'with event', expect.alternations[0]].concat(assertion));
  });
  expect.addAssertion("<".concat(actualPendingEventTypeName, "> [and] with event <string> <object> <assertion?>"), function (expect, subject, eventName, eventArgs) {
    triggerEvent(subject.renderer, subject.target, subject.eventName, subject.eventArgs);
  ...
  expect.addAssertion("<".concat(actualPendingEventTypeName, "> [and] with event (").concat(_reactEventNames["default"].join('|'), ") <object> <assertion?>"), function (expect, subject, eventArgs) {
    for (var _len8 = arguments.length, assertion = new Array(_len8 > 3 ? _len8 - 3 : 0), _key8 = 3; _key8 < _len8; _key8++) {
...
AssertionGenerator.prototype._installWithEventOn = function (expect) {
  var _this$_options4 = this._options,
      actualTypeName = _this$_options4.actualTypeName,
      queryTypeName = _this$_options4.queryTypeName,
      expectedTypeName = _this$_options4.expectedTypeName,
      getRenderOutput = _this$_options4.getRenderOutput,
      getDiffInputFromRenderOutput = _this$_options4.getDiffInputFromRenderOutput,
      triggerEvent = _this$_options4.triggerEvent,
      ActualAdapter = _this$_options4.ActualAdapter,
      QueryAdapter = _this$_options4.QueryAdapter;
  var actualPendingEventTypeName = this._actualPendingEventTypeName;
  expect.addAssertion("<".concat(actualPendingEventTypeName, "> on [exactly] [with all children] [with all wrappers] [with all classes] [with all attributes]<").concat(queryTypeName, "> <assertion?>"), function (expect, subject, target) {
  ...
  expect.addAssertion(["<".concat(actualPendingEventTypeName, "> queried for [exactly] <").concat(queryTypeName, "> <assertion?>"), "<".concat(actualPendingEventTypeName, "> queried for [with all children] [with all wrappers] [with all classes] [with all attributes] <").concat(queryTypeName, "> <assertion?>")], function (expect, subject, expected) {
    triggerEvent(subject.renderer, subject.target, subject.eventName, subject.eventArgs);
...
AssertionGenerator.prototype._installEventHandlerAssertions = function (expect) {
  var _this$_options5 = this._options,
      actualTypeName = _this$_options5.actualTypeName,
      expectedTypeName = _this$_options5.expectedTypeName,
      triggerEvent = _this$_options5.triggerEvent;
  var actualPendingEventTypeName = this._actualPendingEventTypeName;
  expect.addAssertion(["<".concat(actualPendingEventTypeName, "> [not] to contain [exactly] <").concat(expectedTypeName, ">"), "<".concat(actualPendingEventTypeName, "> [not] to contain [with all children] [with all wrappers] [with all classes] [with all attributes] <").concat(expectedTypeName, ">")], function (expect, subject, expected) {
    triggerEvent(subject.renderer, subject.target, subject.eventName, subject.eventArgs);
  ...
  expect.addAssertion("<".concat(actualPendingEventTypeName, "> to have [exactly] rendered [with all children] [with all wrappers] [with all classes] [with all attributes] <").concat(expectedTypeName, ">"), function (expect, subject, expected) {
    triggerEvent(subject.renderer, subject.target, subject.eventName, subject.eventArgs);
...
var _default = AssertionGenerator;
